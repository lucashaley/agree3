...
# Use Active Storage variants for dynamic image generation [https://guides.rubyonrails.org/active_storage_overview.html#transforming-images]
gem "image_processing", "~> 1.2"

# Cloudinary for cloud storage and image transformations
gem "cloudinary"
